...
$sing run -B /eos -B /afs --bind /etc/krb5.conf:/etc/krb5.conf --bind /proc/fs/openafs/afs_ioctl:/proc/fs/openafs/afs_ioctl --bind /usr/vice/etc:/usr/vice/etc  --nv /eos/home-j/jkiesele/singularity/images/deepjetcore3_latest_2021-02-19.13:21.sif
#deepjetcore3_latest.sif
